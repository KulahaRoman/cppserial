#include <cppserial/serializable.h>
#include <cppserial/serializer.h>
...
class Room : public Serializable {
 public:
  ...
  void Serialize(BinaryArchive& archive, Context& context) const override {
    Serializer::Serialize(first, archive, context);
    Serializer::Serialize(second, archive, context);
  }
  void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(first, archive, context);
    Serializer::Deserialize(second, archive, context);
  }
...
class Person : public Serializable {
 public:
  ...
  void Serialize(BinaryArchive& archive, Context& context) const override {
    Serializer::Serialize(name, archive, context);
    Serializer::Serialize(bestie, archive, context);
  }
  void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(name, archive, context);
    Serializer::Deserialize(bestie, archive, context);
  }
...
TEST(SerializerTest, TwoFriendsCyclicReferences) {
  {
    ...
    ASSERT_STREQ(roomIn->GetFirst()->GetName().c_str(),
                 roomOut->GetFirst()->GetName().c_str());
    ASSERT_STREQ(roomIn->GetSecond()->GetName().c_str(),
                 roomOut->GetSecond()->GetName().c_str());
  }
...
class G : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
    ...
    Serializer::Serialize(num, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(num, archive, context);
  }
...
class E : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
                         Context& context) const override {
    Serializer::Serialize(num, archive, context);
    Serializer::Serialize(g, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(num, archive, context);
    Serializer::Deserialize(g, archive, context);
  }
...
class F : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
                         Context& context) const override {
    Serializer::Serialize(num, archive, context);
    Serializer::Serialize(e, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(num, archive, context);
    Serializer::Deserialize(e, archive, context);
  }
...
class D : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
                         Context& context) const override {
    Serializer::Serialize(f, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(f, archive, context);
  }
...
class B : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
                         Context& context) const override {
    Serializer::Serialize(a, archive, context);
    Serializer::Serialize(c, archive, context);
    Serializer::Serialize(d, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(a, archive, context);
    Serializer::Deserialize(c, archive, context);
    Serializer::Deserialize(d, archive, context);
  }
...
class A : public Serializable {
 public:
  ...
  virtual void Serialize(BinaryArchive& archive,
                         Context& context) const override {
    Serializer::Serialize(b, archive, context);
    Serializer::Serialize(f, archive, context);
  }
  virtual void Deserialize(BinaryArchive& archive, Context& context) override {
    Serializer::Deserialize(b, archive, context);
    Serializer::Deserialize(f, archive, context);
  }
